...
#+RESULTS: asdfasdfasdf
:  [1]  6  4 12 13 12  7 15 14 10 12  3 22 13 10 12 11 16 13  6  3  2  8  9  6 10  3 12  3 13  8 12  5 NA 10  9 14 NA 10
...
#+begin_src R :session s1 :file boxplot_Esp_Pos_BY_ESTADOCIVIL.png :results output graphics file
    plot_boxplot(
      var_y = myDados$Esp_Pos,
      var_x = myDados$Genero,
      strTitle = "Estresse Percebido - Pos",
...
[[file:boxplot_Esp_Pos_BY_ESTADOCIVIL.png]]
...
#+begin_src R :session s1 :file boxplot_Esp_Pos_BY_ESCOLARIDADE.png :results output graphics file
    plot_boxplot(
      var_y = myDados$ESP_Pos,
      var_x = myDados$Escolaridade,
      strTitle = "Estresse Percebido - Pre",
...
#+begin_src R :session s1 :file boxplot_FPP.D.pre_BY_ESTADOCIVIL.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.D.pre,
...
#+begin_src R :session s1 :file boxplot_FPP.D.pre_BY_ESCOLARIDADE.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.D.pre,
      var_x = myDados$Escolaridade,
      strTitle = "FPP.D.pre",
...
#+begin_src R :session s1 :file boxplot_FPP.D.pos_BY_ESTADOCIVIL.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.D.pos,
      var_x = myDados$Estado.civil,
      strTitle = "FPP.D.pos",
...
#+begin_src R :session s1 :file boxplot_FPP.D.pos_BY_ESCOLARIDADE.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.D.pos,
      var_x = myDados$Escolaridade,
      strTitle = "FPP.D.pos",
...
#+begin_src R :session s1 :file boxplot_FPP.E.pre_BY_ESTADOCIVIL.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.E.pre,
      var_x = myDados$Estado.civil,
      strTitle = "FPP.E.pre",
...
#+begin_src R :session s1 :file boxplot_FPP.E.pos_BY_ESTADOCIVIL.png :results output graphics file
    plot_boxplot(
      var_y = myDados$FPP.E.pos,
      var_x = myDados$Estado.civil,
      strTitle = "FPP.E.pos",
